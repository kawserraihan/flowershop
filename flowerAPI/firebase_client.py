...
class FirebaseClient:
    ...
    def __init__(self):
        ...
        self._collection = self._db.collection(u'inventory')
    ...
    def create(self, data):
        ...
        try:
            ...
            doc_ref.set(data)
            return doc_ref.id  # Return the document reference
        except Exception as e:
            # Log the error for debugging
            logging.error("Firestore document creation failed: %s" % str(e))
            return None
